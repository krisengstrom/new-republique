...
/**
 * New Republique Custom Post Types
 *
 * Uncomment add_action() to enable
 * Note: These settings are just boilerplates
 */

// add_action( 'init', 'nr_create_post_type' );
function nr_create_post_type() {
...
/**
 * New Republique Custom Taxonomies
 *
 * Uncomment add_action() to enable
 */

// add_action( 'init', 'nr_create_taxonomy', 0 );
function nr_create_taxonomy() {
